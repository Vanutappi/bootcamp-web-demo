...
namespace WorkhourDemo.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Employee_ID,Department_ID,Employee_Name,Start_Date")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Employee_ID,Department_ID,Employee_Name,Start_Date")] Employee employee)
        {
            if (ModelState.IsValid)
            {
